...
function setcss(e, l, s) {
    ...
    for (var n = 0; n < t.length; n++)
        if ("" !== t[n]) {
            if (0 === c && (c = 12 / t[n]), f = 12 / t[n], g = 100 / f, a = s + " > .carousel-logo.active.carousel-logo-right," + s + " > .carousel-logo.carousel-logo-next {-webkit-transform: translate3d(" + g + "%, 0, 0);transform: translate3d(" + g + ", 0, 0);left: 0;}" + s + " > .carousel-logo.active.carousel-logo-left," + s + " > .carousel-logo.carousel-logo-prev {-webkit-transform: translate3d(-" + g + "%, 0, 0);transform: translate3d(-" + g + "%, 0, 0);left: 0;}" + s + " > .carousel-logo.carousel-logo-left, " + s + " > .carousel-logo.carousel-logo-prev.carousel-logo-right, " + s + " > .carousel-logo.active {-webkit-transform: translate3d(0, 0, 0);transform: translate3d(0, 0, 0);left: 0;}", f > 1) {
